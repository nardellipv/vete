    ...
    <div class="content">
        ...
        <div class="panel panel-white">
            ...
            <table class="table table-lg invoice-archive">
                ...
                <tbody>
                @foreach($sellsMonth as $sellMonth)
                    <tr>
                        <td>#{{ $sellMonth->invoice }}</td>
                        <td>#{{ $sellMonth->invoice }}</td>
                        <td>
                            <h6 class="no-margin">
                                <a href="#">{{ $sellMonth->customer->name }}</a>
                                <small class="display-block text-muted">{{ $sellMonth->status }}</small>
                            </h6>
                        </td>
                        <td>{{ $sellMonth->quantity }}</td>
                        <td>{{ \Carbon\Carbon::parse($sellMonth->date)->format('d/m/Y') }}</td>
                        <td>${{ $sellMonth->mount }}</td>
                        <td>${{ $sellMonth->discount }}</td>
                        <td>${{ $sellMonth->mount - $sellMonth->discount }}</td>
